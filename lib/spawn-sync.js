var spawnSync = require('child_process').spawnSync,
    ...
    path = require('path'),
    mainModuleDir = path.dirname( require('require-main-filename')() );
...
if(module === process.mainModule){
    ...
    process.stdin.on('end', function() {
        ...
        // set our mainDir to the parsed value
        mainModuleDir = parsed.mainModuleDir;
...
Object.defineProperty(spawner, 'mainModuleDir', {
  enumerable: false,
  configurable: false,
  writable: false,
  value: function () {
